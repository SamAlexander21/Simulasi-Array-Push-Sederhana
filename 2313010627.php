<?php
session_start();
    if (!isset($_SESSION['username'], $_SESSION['password']) || ($_SESSION['username'] != '2313010627' && (password_verify('2313010627', $_SESSION['password']) == false))) {
        include 'navbar.php';
...
<?php
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        $ktp_627 = $_POST['ktp_627'];
        $nama_627 = $_POST['nama_627'];
        $domisili_627 = $_POST['domisili_627'];
        $skalaUsaha_627 = $_POST['skalaUsaha_627'];
