<?php 
session_start();
    if (!isset($_SESSION['username'], $_SESSION['password']) || ($_SESSION['username'] != '2313010642' && (password_verify('2313010642', $_SESSION['password']) == false))) {
        include 'navbar.php';
    ...
    class daftarPegawai_642 extends pegawai_642 {
        public function __construct($nama_642, $alamat_642, $no_telp_642, $username_642, $password_642) {
            ...
            $this->password = password_hash($password_642, CRYPT_SHA256);
        }
